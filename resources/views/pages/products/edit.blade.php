    ...
    <div class="card-body card-block">
        <form action="{{ route('products.update', $data->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="type" value="{{ old('type') ? old('type') : $data->type  }}" class="form-control @error('type') is-invalid @enderror "/>
            ...
            <div class="form-group">
                ...
                <input type="number" name="price" value="{{ old('price') ? old('price') : $data->price }}" class="form-control @error('price') is-invalid @enderror "/>
                @error('price') <div class="text-muted"> {{ $message }}</div> @enderror
            </div>

            <div class="form-group">
                <label for="quantity" class="form-control-label">Jumlah Barang</label>
                <input type="number" name="quantity" value="{{ old('quantity') ? old('quantity') : $data->quantity }}" class="form-control @error('quantity') is-invalid @enderror "/>
